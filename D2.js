...
console.log("il numero più grande è:", trovaMaggiore);
...
let numb = 10;
let numb2 = 2;
if (numb === 8 || numb2 === 8 || numb + numb2 === 8 || numb - numb2 === 8);
...
let spedizione = 10;
if (totalShoppingCart - spedizione > 50) {
...
let totale = totalShoppingCart - blackFriday;
if (totale > 50) {
  console.log("spedizione gratuita");
} else {
  console.log("spedizione", spedizione);
